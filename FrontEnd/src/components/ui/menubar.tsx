...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none text-foreground data-[state=open]:bg-muted focus:bg-muted",
      className,
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none text-foreground data-[state=open]:bg-muted focus:bg-muted",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-muted",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-muted",
      className,
    )}
    checked={checked}
    {...props}
