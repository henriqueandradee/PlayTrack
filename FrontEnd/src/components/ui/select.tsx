...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-muted",
      className,
    )}
    {...props}
  >
