...
const features = [
  { name: 'Partidas analisadas', free: '3', pro: 'Ilimitadas' },
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="rounded-lg border border-border bg-elevated/50 p-6">
              ...
              <p className="text-text-secondary text-sm mb-4">Até 3 jogos para sentir o valor da plataforma</p>
            ...
            <div className="rounded-lg border border-primary/50 bg-primary/5 p-6 relative overflow-hidden">
              ...
              <p className="text-text-secondary text-sm mb-4">Vídeos e registros ilimitados, com exportação e histórico completo</p>
              <div className="text-3xl font-bold text-foreground mb-4">
