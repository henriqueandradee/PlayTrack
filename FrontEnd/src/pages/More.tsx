...
import { ArrowLeft, Database, FileText, Shield, AlertTriangle, Cookie } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="space-y-4">
          <Link to="/data-rights" className="glass-card p-4 flex items-center gap-3 hover:bg-muted/40 transition-colors">
          ...
          <Link to="/dmca" className="glass-card p-4 flex items-center gap-3 hover:bg-muted/40 transition-colors">
            <div className="p-2 bg-muted rounded-md">
              <AlertTriangle className="h-4 w-4 text-primary" />
            </div>
            <div>
              <p className="font-medium text-foreground">Reportar DMCA</p>
              <p className="text-sm text-text-secondary">Envie uma notificação de conteúdo que viole direitos autorais.</p>
            </div>
          </Link>

          <Link to="/privacy" className="glass-card p-4 flex items-center gap-3 hover:bg-muted/40 transition-colors">
            <div className="p-2 bg-muted rounded-md">
          ...
          <Link to="/terms" className="glass-card p-4 flex items-center gap-3 hover:bg-muted/40 transition-colors">
            <div className="p-2 bg-muted rounded-md">
