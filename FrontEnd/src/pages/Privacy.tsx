            ...
            <section>
              ...
              <div className="bg-card border border-border p-4 rounded-lg mb-4">
                ...
                <ul className="list-disc list-inside text-text-secondary space-y-1">
                  ...
                  <li><strong>Nome de exibição</strong>: opcional, para personalizar seu perfil</li>
                  <li><strong>Avatar</strong>: opcional, para personalizar seu perfil</li>
                  <li><strong>Função</strong>: opcional (atleta, técnico, analista)</li>
